...
const Hero = ({
  ...
  return (
    <div className="flex justify-center">
      <div className="my-8 -ml-44 md:my-36 md:ml-8 xl:ml-56 2xl:ml-72 relative z-10">
      ...
      <div
        className={`absolute md:relative w-[280px] h-[280px] md:w-[450px] md:h-[480px] ml-16 md:mt-16 md:-ml-20 -z-10`}
      >
